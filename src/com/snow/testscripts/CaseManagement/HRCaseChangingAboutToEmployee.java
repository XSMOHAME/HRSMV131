...
public class HRCaseChangingAboutToEmployee extends ReusableLibrary {
	...
	public void createCase(Map<Object, Object> data) throws Exception {
		...
		// seach for the Guest user in the search requester bar
	...
	public void changeAboutToEmployee(Map<Object, Object> data) throws Exception {
		KnowledgeCreationPage knowledgeCreation = new KnowledgeCreationPage(driver);
		LoginPage loginPage = new LoginPage(driver);
		HRCreateCaseGuest createGuest = PageFactory.initElements(driver, HRCreateCaseGuest.class);
		...
		String about = (String) data.get("Employee");
