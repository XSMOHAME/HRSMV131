...
public class DashboardListView extends ReusableLibrary {
	
	ReadData rd = new ReadData();
	@Test(dataProvider="data")
	public void dashBoardListView(Map<Object, Object> data) throws Exception{
		...
		hrdashboard.validateHRDashboard();
