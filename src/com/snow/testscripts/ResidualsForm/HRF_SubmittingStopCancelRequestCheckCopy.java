...
public class HRF_SubmittingStopCancelRequestCheckCopy extends ReusableLibrary {
	...
	@Test(priority = 7, dataProvider = "data", groups = "CreateStopCancelCheckCopyRequest")
	public void createStopCancelRequestCheckCopy(Map<Object, Object> data) throws Exception {
		...
		test.get().log(Status.INFO, MarkupHelper
				.createLabel("**Test for Submitting a STOP/CANCEL REQUEST :  Check Copy**", ExtentColor.ORANGE));
		...
		String testPayee = (String) data.get("TestWorker");
...
//		String reason = (String) data.get("Reason");
		...
		residualsFormPage.validateTestPayee(testPayee);
...
//		residualsFormPage.validateReasonDropDown(reasonArray, reason);
	...
	public Object[][] getData() throws IOException {
		...
		for (int i = 0; i < excelData.length; i++) {
			if (excelData[i][0].toString().contains("TestCaseFor=Residuals: Stop/Cancel Request: Check Copy")) {
