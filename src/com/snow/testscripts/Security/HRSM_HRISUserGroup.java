...
public class HRSM_HRISUserGroup extends ReusableLibrary {
	...
	public void securityProcessForm(Map<Object, Object> data) throws Exception {
		...
		test.get().log(Status.INFO,
				MarkupHelper.createLabel("** Security Test for HRIS User Group**", ExtentColor.ORANGE));
	...
	public Object[][] getData() throws IOException {
		...
		for (int i = 0; i < excelData.length; i++) {
			if (excelData[i][0].toString().contains("HRSM_HRISUserGroup")) {
