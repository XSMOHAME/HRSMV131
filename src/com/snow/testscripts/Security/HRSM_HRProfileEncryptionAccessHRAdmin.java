...
import com.snow.pageobjects.HR_PROFILE_ENCRYPTION_ACCESS_HRADMIN;
import com.snow.pageobjects.KnowledgeCreationPage;
import com.snow.pageobjects.LoginPage;

public class HRSM_HRProfileEncryptionAccessHRAdmin extends ReusableLibrary {
	...
	public void security_Form_validation(Map<Object, Object> data) throws Exception {
		...
		HR_PROFILE_ENCRYPTION_ACCESS_HRADMIN hr = PageFactory.initElements(driver,
				HR_PROFILE_ENCRYPTION_ACCESS_HRADMIN.class);
	...
	public Object[][] getData() throws IOException {
		...
		for (int i = 0; i < excelData.length; i++) {
			if (excelData[i][0].toString().contains("HRSM_HRProfileEncryptionAccessHRAdmin")) {
