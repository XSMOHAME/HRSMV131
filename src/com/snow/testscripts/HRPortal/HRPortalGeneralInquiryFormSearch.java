...
public class HRPortalGeneralInquiryFormSearch extends ReusableLibrary {
	ReadData rd = new ReadData();

	@Test(dataProvider = "data", priority = 1)
	public void hrPortalGeneralInquiryFormSearch(Map<Object, Object> data)
	...
	public Object[][] getData() throws IOException {
		...
		for (int i = 0; i < excelData.length; i++) {
			if (excelData[i][0].toString().contains("TestCaseFor=HRPortalGeneralInquiryFormSearch")) {
