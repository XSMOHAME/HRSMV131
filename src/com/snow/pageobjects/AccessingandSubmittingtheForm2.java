...
public class AccessingandSubmittingtheForm2 extends ReusableLibrary {
	public WebDriver driver;

	public AccessingandSubmittingtheForm2(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//*[@id ='sc_cat_item.do']/descendant::button[contains(text(), 'Add row')]")
	...
	public void validate_startdate() throws Exception {
		waitForElement(driver, wbsf_start_date);
	...
	public void validate_enddate() throws Exception {
		...
		waitForElement(driver, wbsf_end_date);
	...
	public void validate_Requirements_with_Proficiency_text() throws Exception {
		waitForElement(driver, wbsf_Requirements_with_profeciency_text);
	...
	public void validating_table_rows() throws Exception {
		...
		wbsf_table_button = driver
				.findElement(By.xpath("//*[@id ='tester']/descendant::button[contains(@title, 'Add row')]"));
		System.out.println("Button Text - " + wbsf_table_button.getText().trim());
		wbsf_table_button.click();

		Actions actions = new Actions(driver);
		actions.doubleClick(wbsf_table_button).build().perform();
		waitForAction(driver);
	...
	public void validate_newly_added_row(String text) throws Exception {
		...
		try {
			...
			waitForElement(driver, wbsf_table_skills7);
			new Select(wbsf_table_skills7).selectByVisibleText(text);
			System.out.println("alert is displayed==" + driver.getTitle());
			test.get().log(Status.PASS,
	...
	public void validate_submit_button() throws Exception {
		...
		waitForElementToBeClickable(driver, ch_caseID);
