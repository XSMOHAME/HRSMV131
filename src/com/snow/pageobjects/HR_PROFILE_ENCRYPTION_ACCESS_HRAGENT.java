...
public class HR_PROFILE_ENCRYPTION_ACCESS_HRAGENT extends ReusableLibrary {
	public WebDriver driver;

	public HR_PROFILE_ENCRYPTION_ACCESS_HRAGENT(WebDriver driver) {
		this.driver = driver;
	...
	public void navigateToHRDashboard(String hrProfileUser) throws Exception {
		...
		Thread.sleep(3000);
		waitForFrameToBeAvailable(driver, "gsft_main");
		waitForElement(driver, user_home_title);
